...
while True:
    ...
    if decision == "1":
        ...
        if not Truck:
            ...
            Dispatch_line.insert(0, returned_item)
            print(f"Your {returned_item} is back at dispatch line")

    elif decision == "4":
        print(f"Dispatch line queue front {Dispatch_line} bacl")
        print(f"Truck queue, back {Truck} front")
